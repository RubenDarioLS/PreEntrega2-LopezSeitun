...
const CartItem = ({ title, price, id, quantity }) => {
  ...
  return (
    <div className="text-white flex justify-around m-4  items-center lg:my-10  lg:mx-24 ">
      ...
      <p className="flex flex-col justify-center items-center text-sm lg:flex-row lg:mx-auto lg:text-lg ">Precio:&#160; <span>${price}</span></p>
      <p className="flex flex-col justify-center items-center text-sm lg:flex-row lg:mx-auto lg:text-lg ">Cantidad:&#160; <span>{quantity}</span></p>
